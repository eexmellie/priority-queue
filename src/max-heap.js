...
class MaxHeap {
	...
	restoreRootFromLastInsertedNode(detached) {
		...
		if (oldRootParent) {
			...
			if(oldRootParent !== detached && !oldRootParent.right && this.parentNodes.indexOf(oldRootParent) < 0) {
